...
__all__ = ('RestructuredTextDocument', )
...
if 'KIVY_DOC' not in os.environ:
    ...
    for rolename, nodeclass in list(generic_docroles.items()):
...
class RestructuredTextDocument(ScrollView):
    ...
    '''Specifies the background_color to be used for the RestructuredTextDocument.
    ...
    .. warning::
        ...
        :meth:`RestructuredTextDocument.render` if you change them after loading.
    ...
    def __init__(self, **kwargs):
        ...
        super(RestructuredTextDocument, self).__init__(**kwargs)
...
if __name__ == '__main__':
    ...
    import sys
    runTouchApp(RestructuredTextDocument(source=sys.argv[1]))
